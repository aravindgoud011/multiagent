...
def create_azure_sql_tables():
    ...
    try:
        ...
        # Initialize shop_status if not exists
        cursor.execute("IF NOT EXISTS (SELECT * FROM settings WHERE [key]='shop_status') INSERT INTO settings ([key], [value]) VALUES ('shop_status', 'open')")
